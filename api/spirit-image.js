...
const SPIRIT_IMAGE_PROMPT_VERSION = "electronic-party-bust-v32-party-gear";
const SPIRIT_IMAGE_STORE_PREFIX = "sonic:spirit-image:v26";
...
const SPIRIT_ENTITY_BRIEFS = {
  ...
  estilista_tech_house: "adult tech-house / bass-house groove pilot archetype, social club charisma, booth-aware confidence, visible happy face, technical mesh or transparent-vinyl clubwear, asymmetric utility zipper vest or crossbody strap, two or three distinct non-duplicated accessories such as transparent in-ear monitor, club wristband, single ear cuff or clean chain, DJ mixer fader geometry, CDJ jog-wheel arcs, equalizer blocks, chopped-vocal LED fragments, dry bass pulse bars, not a plain leather-jacket portrait",
...
module.exports = async function handler(req, res) {
  ...
  const safePrompt = [
    ...
    "PARTY-GEAR MINIMUM: do not generate a normal unaccessorized person. The upper chest and shoulders must visibly include electronic-scene gear: a utility harness or asymmetric zipper vest or transparent-vinyl/mesh club layer, plus one transparent in-ear monitor, club wristband, ear cuff, angular visor, headphones, or clean chain. Use two or three different accessory roles, never duplicates. If the outfit is a simple shirt, plain jacket, or ordinary fashion top, the image fails.",
    ...
    "Strict negative style: no duplicate accessories, no two pairs of glasses, no glasses on face plus glasses on forehead, no repeated necklaces, no repeated pendants, no excessive beads, no duplicated ear cuffs, no accessory clutter, no plain black leather jacket, no plain black T-shirt, no simple pendant-only styling, no clean headshot, no centered passport composition, no corporate beauty portrait, no ordinary fashion portrait, no LinkedIn portrait, no dating-profile portrait, no carnival feathers, no samba costume, no circus/clown feeling, no cartoon, no anime, no childish illustration, no mascot, no emoji, no doll, no flat vector, no abstract crystal, no blank gradient, no placeholder, no robot body, no creature, no skull, no plastic mannequin, no deformed face, no crossed eyes, no hands dominating the frame, no full body, no aggressive expression, no generic fantasy character, no medieval costume, no acoustic instruments, no guitars, no lyres, no tambourines, no ordinary DJ press photo, no plain passport portrait.",
